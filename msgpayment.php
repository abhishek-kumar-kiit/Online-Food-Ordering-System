...
<body>
    <div class="wrapper">
            <div style="font-weight: bold;text-align: center;color:green;">Your payment is Done Succesfull!! </div>
             <div class="input-group">
                <div class="input-box" style="text-align: center;">
                    <a href="customerpage.php" style="margin-right: 40px;">Continue Buy</a>
