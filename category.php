    ...
    <div class="home-content">
       <table>
        <a href="newcategory.php">Add New Category</a>
            ...
            ?>
            <tr>
            <td><p style="font-size: 13px;"><?php print($row['date']); ?></p></td>
            <td><p style="font-size: 13px;"><?php print($row['category']); ?></p></td>
            <td><p style="font-size: 13px;"><?php print($row['details']); ?></p></td>
